...
model_name="mobilenet_v2_035_instance_3"
log_dir="dec1/train"
...
ckpt="mobilenet_v2_0.35_224.ckpt"
checkpoint_exclude_scopes="MobilenetV2/Logits,MobilenetV2/Conv_1,MobilenetV2/Conv_2,MobilenetV2/Conv_3,MobilenetV2/Conv_4,MobilenetV2/Conv_5,MobilenetV2/Decoder"
trainable_scopes="MobilenetV2/Logits,MobilenetV2/Conv_2,MobilenetV2/Conv_2,MobilenetV2/Conv_3,MobilenetV2/Conv_4,MobilenetV2/Conv_5,MobilenetV2/Decoder"
...
INIT_CHECKPOINT="${HOME}/models/workspace/seg/model/mobilenet_v2_0.35/${ckpt}"
TRAIN_DIR="${HOME}/models/workspace/seg/coco-instance/model_instance_reshape_3"
#mkdir -p ${TRAIN_DIR}
