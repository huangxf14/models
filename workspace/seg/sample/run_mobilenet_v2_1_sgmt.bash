...
ckpt="mobilenet_v2_1.0_224.ckpt"
checkpoint_exclude_scopes="MobilenetV2/Logits,MobilenetV2/Conv_1,MobilenetV2/Conv_2,MobilenetV2/Conv_3,MobilenetV2/Decoder"
...
train_steps_new=10000  # 10000 steps, about 2 epoches
second_stage_dir="all"
num_clones=1
batch_size=20
train_steps=400000     # 300000 steps, about 30 epoches
...
INIT_CHECKPOINT="${HOME}/models/workspace/seg/model/mobilenet_v2_1.0/${ckpt}"
TRAIN_DIR="${HOME}/models/workspace/seg/coco-instance/model_1.0"
#mkdir -p ${TRAIN_DIR}
