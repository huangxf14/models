...
#               activation_fn=None,
               ...
               normalizer_params={'center': True, 'scale': True,
                                  'is_training': is_training},
               biases_initializer=init_ops.zeros_initializer())
  temp_skip_res = [[16, 16],[32, 32], [64, 64], [128, 128], [256, 256], [512, 512]]
  with tf.variable_scope(scope):
    output = net_outputs
    output = tf.reshape(output, [-1,16,16,2])
...
def mobilenet(inputs,
  ...
  with tf.variable_scope(scope, 'Mobilenet', reuse=reuse) as scope:
    ...
    if use_decoder:
      num_skips = 5
      decoder_inputs = [end_points['layer_20'],
                        end_points['layer_14'],
                        end_points['layer_7'],
                        end_points['layer_4'],
                        end_points['layer_2'],
      ...
      skip_res = [[16, 16],[32, 32], [64, 64], [128, 128], [256, 256], [512, 512]]
