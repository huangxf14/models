...
model_name="mobilenet_v2_075_instance"
log_dir="dec1/train"
...
ckpt="mobilenet_v2_0.75_224.ckpt"
...
INIT_CHECKPOINT="${HOME}/models/workspace/seg/model/mobilenet_v2_0.75/${ckpt}"
TRAIN_DIR="${HOME}/models/workspace/seg/coco-instance/model075_instance"
