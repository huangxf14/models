...
tfrecord_dir="LV-instance/tfrecord_simple"
...
INIT_CHECKPOINT="${HOME}/models/workspace/seg/coco-instance/model_instance_reshape_2/all/${ckpt}"
TRAIN_DIR="${HOME}/models/workspace/seg/LV-instance/model_instance_reshape_2"
#mkdir -p ${TRAIN_DIR}
