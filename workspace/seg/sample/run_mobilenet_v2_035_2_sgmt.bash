...
trainable_scopes="MobilenetV2/Logits,MobilenetV2/Conv_2,MobilenetV2/Conv_2,MobilenetV2/Conv_3,MobilenetV2/Conv_4,MobilenetV2/Decoder"

num_clones_new=1
batch_size_new=50    # 192 * 2  
train_steps_new=20000  # 10000 steps, about 16 epoches
second_stage_dir="all"
num_clones=1
batch_size=25
train_steps=250000     # 100000 steps, about 40 epoches
...
TRAIN_DIR="${HOME}/models/workspace/seg/coco-instance/model035_2"
#mkdir -p ${TRAIN_DIR}
