...
num_clones_new=1
batch_size_new=25    # 192 * 2  
train_steps_new=1  # 10000 steps, about 8 epoches
second_stage_dir="all"
num_clones=1
batch_size=13
train_steps=1     # 100000 steps, about 60 epoches
...
TRAIN_DIR="${HOME}/models/workspace/seg/RGMP/model_test2"
#mkdir -p ${TRAIN_DIR}
