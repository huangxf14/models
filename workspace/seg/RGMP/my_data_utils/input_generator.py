...
from my_data_utils import input_preprocess
...
def _get_data(data_provider, dataset_split):
  ...
  image, height, width, last_mask, first_image, first_mask = data_provider.get(
      [common.IMAGE, common.HEIGHT, common.WIDTH, common.LAST_MASK, common.FIRST_IMAGE, common.FIRST_MASK])
  ...
  return image, label, image_name, height, width, last_mask, first_image, first_mask
...
def get(dataset,
  ...
  data_provider = dataset_data_provider.DatasetDataProvider(
      ...
      shuffle=is_training)
  image, label, image_name, height, width, last_mask, first_image, first_mask = _get_data(data_provider,
                                                      dataset_split)
