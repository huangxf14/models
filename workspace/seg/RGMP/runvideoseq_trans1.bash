...
TRAIN_DIR="${HOME}/models/workspace/seg/RGMP/modelRGMP1/lr"
TRAIN_TRAN_DIR="${HOME}/models/workspace/seg/RGMP/modelRGMP1"
...
python train_video_sgmt.py \
  ...
  --checkpoint_path=${TRAIN_TRAN_DIR}/${trans_stage_dir} \
